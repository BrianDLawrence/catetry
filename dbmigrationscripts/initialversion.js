/**
 * This script creates the initial version of the mongoDB database for Catetry
 */
...
async function run() {
    try {
        ...
        // Check for "Poems" collection
        if (collectionNames.includes("Poems")) {
            console.log("Poems collection exists");
        } else {
            console.log("Poems collection does not exist. Creating...");
            await database.createCollection("Poems");
