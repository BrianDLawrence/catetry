<template>
  ...
  <div class="flex justify-center">
    <div class="pb-8 prose">
      <p><strong>Last updated:</strong> August 7th, 2025</p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>Our Website uses OpenAI ChatGPT 4.1 Mini if you choose to generate a poem.
            The responses generated by ChatGPT 4.1 Mini on this website are based on patterns in
            data and do not reflect
            the opinions, beliefs, or values of Catetry (Spero Autem LLC). The output from ChatGPT 4.1 Mini is
            generated by a machine learning model, and as such, may not always be accurate, appropriate, or free from
            bias.</p>

          <p>While we strive to provide helpful and accurate information, Catetry (Spero Autem LLC) makes no
            representations or
            warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or
            availability of the responses generated by ChatGPT 4.1 Mini. Any reliance you place on such information is
            therefore strictly at your own risk.</p>

          <p>In no event will Catetry (Spero Autem LLC) be liable for any loss or damage, including without
            limitation, indirect or
            consequential loss or damage, or any loss or damage whatsoever arising from the use of ChatGPT 4.1 Mini on
            this
            website.</p>

          <p>Please note that the content generated by ChatGPT 4.1 Mini may be subject to OpenAI's use-case policy and
