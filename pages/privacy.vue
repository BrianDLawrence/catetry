<template>
  ...
  <div class="flex justify-center">
    <div class="pb-8 prose">
      <p><strong>Last updated:</strong> January 4th, 2024</p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>Our Website uses OpenAI ChatGPT 3.5 Turbo if you choose to generate a poem.
            The responses generated by ChatGPT 3.5 Turbo on this website are based on patterns in
            data and do not reflect
            the opinions, beliefs, or values of Catetry (Spero Autem LLC). The output from ChatGPT 3.5 Turbo is
